...
博德之门游戏中手持远程武器的人物，在被敌人接近（4呎内）时会遭受攻击检定-8、被攻击检定-4的惩罚，而使用手枪、冲锋枪、霰弹枪、短突这样的近战武器不应该遭受这种惩罚，因此做了补偿。

具体补偿的实现机能是，当敌人进入持枪玩家4呎内时，持短枪者获得命中+10有利、防御+4有利的补偿。不过每秒只能进行一次距离判断，不一定及时。
...
添加了法语版，由Deepseek翻译。
取消了枪械点射扫射时偶然会不可控地射中其它目标（如队友）的设置
需要进行修理的话，对话的人身上必须带着要修的东西，现在进行了对话提醒
彻底修正枪械无法正常针对不同护甲类型打出不同特效概率的问题
枪械特效概率严格按照描述配置针对不同装甲的百分比数值
强穿透的枪械对大体型生物打出特效的概率提升
机枪长点射和扫射有效范围增加（差不多1.5倍视距），小心流弹打中远处的生物；冲锋枪范围仍为视距
修正Ultimax 100无法单手持用的问题
修正商人不卖手套的问题
减少了部分无用的物品文件
驾驶坦克时可以免疫毒素、疾病和吸取属性，并且豁免+5有利
修正人物离开坦克后，短时间内仍然对附近生物有碾压效果的问题
修正达姆弹和银弹的附魔错误
催泪喷雾可以使敌人倒地打滚
修正飞行手雷和浮游炮容易被范围法术伤害、无法飞跃障碍的问题
修正浮游炮攻击和跟随不正常的问题
防弹衣和防弹盾牌有概率防护狙击榴碎片
部分头盔不能防护致命一击的问题修正
修正了英文版中少许描述存在“轮”和“回合”混淆的问题

v0.992

枪械将人击倒后，挨打不会立刻爬起
手榴弹现在可以显示攻击范围（需要在游戏设置中开启法术范围显示）
火焰喷射器生效角度提升到30°
修正震撼弹无法让人昏迷的问题
修正催泪弹导致施法失败是永久效果的问题
浮游炮攻击频率提升，并且现在优先攻击而不是靠近主人
大幅降低了枪械熟练度升级的要求
修正部分药剂不起作用的问题
修正坦克不限次数使用的问题
修正飞行手雷被打坏后如未自爆，会一直存在视野的问题

v0.991

修正了开火时人物脚下会爆出火球动画的问题
修正了在EET上安装时商人在那西凯矿场不送东西的问题
...
修正部分枪械装载石弹也能正常工作的问题
修正部分枪械损坏后消失的问题
石肤术现在可以防护低动能弹药的所有伤害和特效，以及防护高动能弹药的伤害和大部分特效（但会受到击退等影响）
...
又双叒重做了一次几乎所有物品的图像，谢天谢地EE版支持比原版大得多的图像，而且这次学会了批处理一键扣图。
不再支持非EE版本。
彻底重置武器连发机制，尽可能向真实靠拢。
...
闪光弹和震撼弹的有效范围增加到30呎，以及其它一些细节的数据调整。
精简了物品说明。
